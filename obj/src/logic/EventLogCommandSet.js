...
class EventLogCommandSet extends pip_services_commons_node_1.CommandSet {
    ...
    makeReadCommand() {
        return new pip_services_commons_node_2.Command("read", null, (correlationId, args, callback) => {
    ...
    makeWriteCommand() {
        return new pip_services_commons_node_2.Command("write", null, (correlationId, args, callback) => {
