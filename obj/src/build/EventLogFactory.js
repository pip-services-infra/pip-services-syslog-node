...
const EventLogRestServiceV1_1 = require("../services/version1/EventLogRestServiceV1");
...
class EventLogFactory extends pip_services_commons_node_1.Factory {
    constructor() {
        ...
        this.registerAsType(EventLogFactory.RestServiceDescriptor, EventLogRestServiceV1_1.EventLogRestServiceV1);
    }
}
...
EventLogFactory.RestServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-eventlog", "service", "rest", "*", "1.0");
