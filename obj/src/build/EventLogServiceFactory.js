...
class EventLogServiceFactory extends pip_services_commons_node_1.Factory {
    constructor() {
        super();
...
EventLogServiceFactory.Descriptor = new pip_services_commons_node_2.Descriptor("pip-services-eventlog", "factory", "default", "default", "1.0");
EventLogServiceFactory.MemoryPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-eventlog", "persistence", "memory", "*", "1.0");
EventLogServiceFactory.FilePersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-eventlog", "persistence", "file", "*", "1.0");
EventLogServiceFactory.MongoDbPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-eventlog", "persistence", "mongodb", "*", "1.0");
EventLogServiceFactory.ControllerDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-eventlog", "controller", "default", "*", "1.0");
EventLogServiceFactory.SenecaServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-eventlog", "service", "seneca", "*", "1.0");
EventLogServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-eventlog", "service", "http", "*", "1.0");
