...
class SystemEventV1Schema extends pip_services_commons_node_1.ObjectSchema {
    constructor() {
        super();
        ...
        this.withRequiredProperty('severity', pip_services_commons_node_2.TypeCode.Long);
        this.withOptionalProperty('message', pip_services_commons_node_2.TypeCode.String);
        this.withOptionalProperty('details', pip_services_commons_node_2.TypeCode.Map);
    }
}
